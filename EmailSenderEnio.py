...
body_html = """<html>
<body>
<p>Hi Leticia, good morning,<br>
This is my clock in for today.<br>
Please let me know if you have any questions.<br>
Best regards,<br>
</p>
<p style='margin-bottom:12.0pt'><strong><span style='font-family:"Calibri",sans-serif'>Enio Rodriguez</span></strong></p>
<p style='margin-bottom:12.0pt'><span style='font-size:9.0pt'>Service Desk</o:p></span></p>
<p style='margin-bottom:12.0pt'><span style='font-size:9.0pt'>Darwin TC Group, LLC<o:p></o:p></span></p>
<p style='margin-bottom:12.0pt'>Email: <a href="mailto:erodriguez@darwintcgroup.com">erodriguez@darwintcgroup.com</a></p>
<img src=\"\" alt="Image">
...
sender = "ERodriguez@darwintcgroup.com"
receiver = "ERodriguez@darwintcgroup.com"

image_path = r"C:\Users\Enio Rodriguez\AppData\Roaming\Microsoft\Signatures\Enio (ERodriguez@darwintcgroup.com)_files\image001.jpg"  # Reemplaza con la ruta de tu imagen
